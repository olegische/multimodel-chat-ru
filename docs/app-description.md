...
- Настройки генерации текста:
  - Выбор модели (YandexGPT Lite/Pro)
...
- **Функциональность**:
  ...
  - **Выбор модели**: Позволяет пользователю выбрать версию YandexGPT:
...
- При открытии приложения, пользователю отображается главная страница с интерфейсом чата, включая поле ввода для текста и область для истории сообщений. В интерфейсе также отображается кнопка для отпра��ки сообщения и параметры для настройки генерации текста (например, температура, длина ответа).
